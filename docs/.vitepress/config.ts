      ...
      '/components/': [
        {
          ...
          items: [
            ...
            { text: 'GkTextarea', link: '/components/textarea' },
            { text: 'GkCheckbox', link: '/components/checkbox' },
            { text: 'GkRadioGroup & GkRadio', link: '/components/radio' },
            { text: 'GkSelect', link: '/components/select' },
